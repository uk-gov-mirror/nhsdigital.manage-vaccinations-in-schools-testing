...
def test_vaccination_file_upload_historic_valid_data(
    setup_hist_vaccs, import_records_journey_page
):
    """
    ...
    """
    import_records_journey_page.upload_and_verify_output(VaccsFileMapping.HIST_POSITIVE)
...
def test_vaccination_file_upload_historic_invalid_data(
    ...
    LongBatchNumber
    """
    import_records_journey_page.upload_and_verify_output(VaccsFileMapping.HIST_NEGATIVE)
...
def test_historical_vaccination_file_upload_creates_child(
    ...
    import_records_journey_page.upload_and_verify_output(VaccsFileMapping.HIST_HPV)
    dashboard_page.click_mavis()
